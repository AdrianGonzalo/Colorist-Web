...
//       {/* Caja del modal */}
//       <motion.div
//         className="bg-[#0c0c0c] w-full max-w-4xl overflow-hidden shadow-2xl mx-4 relative"
...
//           <button
//             onClick={onClose}
//             className="bg-white/20 hover:bg-white/30 text-white font-medium px-4 py-2 rounded backdrop-blur-sm transition"
//           >
//             Cerrar
//           </button>
//         </div>
